...
export class SceneMain extends Phaser.Scene {
    ...
    preload() {
        this.load.spritesheet("sprWater", "dist/assets/sprWater.png", {
            frameWidth: 16,
            frameHeight: 16
        });
        this.load.image("sprSand", "dist/assets/sprSand.png");
        this.load.image("sprGrass", "dist/assets/sprGrass.png");
    }
    create() {
        this.anims.create({
            key: "sprWater",
